...
namespace BizMate.Infrastructure.Migrations
{
    ...
    [Migration("20260629031944_LinkTechnicianUserAndMergeBorrowTypes")]
    partial class LinkTechnicianUserAndMergeBorrowTypes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BizMate.Domain.Entities.TechnicianBorrowRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("StoreId", "RequestStatus", "NeededDate")
                        .HasDatabaseName("IX_TechnicianBorrowRequests_Store_Status_Date");

                    b.ToTable("TechnicianBorrowRequests");
                });

            modelBuilder.Entity("BizMate.Domain.Entities.TechnicianBorrowRequestItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("TechnicianBorrowRequestId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TechnicianBorrowRequestId", "ProductId")
                        .HasDatabaseName("IX_TechnicianBorrowRequestItems_Request_Product");

                    b.ToTable("TechnicianBorrowRequestItems");
                });
            ...
            modelBuilder.Entity("BizMate.Domain.Entities.TechnicianHolding", b =>
                {
                    ...
                    b.HasIndex("StoreId", "TechnicianId", "ProductId", "BorrowType")
                        .IsUnique()
            ...
            modelBuilder.Entity("BizMate.Domain.Entities.Technician", b =>
                {
                    ...
                    b.HasOne("BizMate.Domain.Entities.User", "User")
                        .WithOne("Technician")
                        .HasForeignKey("BizMate.Domain.Entities.Technician", "UserId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("BizMate.Domain.Entities.TechnicianBorrowRequestItem", b =>
                {
                    ...
                    b.HasOne("BizMate.Domain.Entities.TechnicianBorrowRequest", "TechnicianBorrowRequest")
                        .WithMany("Items")
                        .HasForeignKey("TechnicianBorrowRequestId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Product");

                    b.Navigation("TechnicianBorrowRequest");
                });
